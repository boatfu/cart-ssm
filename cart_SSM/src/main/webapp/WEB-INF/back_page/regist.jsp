        ...
        <div class="row h-100 align-items-center justify-content-center text-center">
            ...
            <div class="col-xs-6 col-md-4 col-center-block">
                <form class="form-signin" action="/regist" method="post">
                    ...
                    <input type="password" id="inputPassword" name="password" class="form-control" placeholder="密码" required=""><label for="inputPassword" class="sr-only">确认密码</label><input type="password" id="inputPasswordre" name="passwordre" class="form-control" placeholder="确认密码" required="">
