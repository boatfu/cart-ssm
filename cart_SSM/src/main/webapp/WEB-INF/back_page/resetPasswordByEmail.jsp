    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            ...
            <div class="col-xs-6 col-md-4 col-center-block">
                <form class="form-signin" action="/resetPasswordByEmail" method="post">
                    ${msg}
                    <label for="password" class="sr-only">请输入你的新密码</label>
                    <input type="text" id="password" name = "password" class="form-control" placeholder="请输入你的新密码" required="" autofocus="">
                        <label for="passwordre" class="sr-only">确认密码</label>
                        <input type="text" id="passwordre" name = "passwordre" class="form-control" placeholder="确认密码" required="" >
