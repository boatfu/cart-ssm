        ...
        <div class="row h-100 align-items-center justify-content-center text-center">
            ...
            <div class="col-xs-6 col-md-4 col-center-block">
                <form class="form-signin" action="/login" method="post">
                    ${msg}
                    <label for="username" class="sr-only">请输入账号或邮箱</label>
                    <input type="text" id="username" name = "name" class="form-control" placeholder="请输入账号或邮箱" required="" autofocus="">
                    <label for="inputPassword" class="sr-only">密码</label>
                    <input type="password" id="inputPassword"name = "password" class="form-control" placeholder="密码" required="">

                    <button class="btn btn-lg btn-primary btn-block" type="submit">登录</button>
                        <a  href="/findPasswordByEmailHtml"><div style="color :darkslategrey" class="btn btn-lg btn-primary btn-block" type="submit">忘记密码?</div></a>
                </form>
            </div>
