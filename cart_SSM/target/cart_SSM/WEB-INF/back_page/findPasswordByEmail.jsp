    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            ...
            <div class="col-xs-6 col-md-4 col-center-block">
                <form class="form-signin" action="/findPasswordByEmail" method="post">
                    ${msg}
                    <label for="username" class="sr-only">请输入你的邮箱</label>
                    <input type="text" id="username" name = "email" class="form-control" placeholder="请输入你的邮箱" required="" autofocus="">
