        ...
        <div class="row h-100 align-items-center justify-content-center text-center">
            ...
            <div class="col-xs-6 col-md-4 col-center-block">
                <form class="form-signin" action="/editProduct" method="post">
                    ...
                    <input type="text" id="name" name="name" class="form-control" placeholder="商品名称:${product.name}" required=""
                           autofocus="" value="${product.name}">
                    <label for="price" class="sr-only">商品价格</label>
                    <input type="text" id="price" name="price" class="form-control" placeholder="价格:${product.price}"
                           required="" value="${product.price}">
                    <button class="btn btn-lg btn-primary btn-block" type="submit" name="id" value="${product.id}">修改</button>
                </form>
            </div>
