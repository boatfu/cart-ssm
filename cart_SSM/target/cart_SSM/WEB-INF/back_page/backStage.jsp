    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            ...
            <div class="col-xs-6 col-md-4 col-center-block" >
                ...
                <a class="btn btn-lg btn-primary btn-block" href="/addUserHtml" >添加用户</a>
                <a class="btn btn-lg btn-primary btn-block" href="/productList" >管理商品</a>
                <a class="btn btn-lg btn-primary btn-block" href="/orderList" >查看订单</a>
            ...
            <table class="table table-striped table-bordered table-hover table-condensed ">
                ...
                <c:forEach items="${users}" var="s" varStatus="status">
                    <tr>
                        ...
                        <td><a href="/editUserHtml?id=${s.id}" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-edit"></span> </a></td>
                        <td><a href="/deleteUser?id=${s.id}" onclick="javascript:return del();" class="btn btn-info btn-lg"><span
