    ...
    <div class="container h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            ...
            <div class="col-xs-6 col-md-4 col-center-block">
                <form class="form-signin" action="/formOrder" method="post">
                    ${msg}

                    <div class="input-group">
                        <span class="input-group-addon">用户</span>
                        <input type="text" readonly id="name" name="name" class="form-control" required=""
                               value="${name}">
                    </div>

                    <div class="input-group">
                        <span class="input-group-addon" id=>商品</span>
                        <input type="text"  readonly id="info" name="info" class="form-control" required=""
                               value="${info}"></div>
                        <div class="input-group">
                            <span class="input-group-addon" id=>单价</span>
                            <input type="text"  readonly id="price" name="price" class="form-control" required="" value="${price}"
                            ></div>

                    <div class="input-group">
                        <span class="input-group-addon" id=>数量</span>
                        <input type="text"  id="buy_counts" name="buy_counts" class="form-control" required=""
                               ></div>

                    <button class="btn btn-lg btn-primary btn-block" type="submit">确认订单</button>
                </form>
            </div>
