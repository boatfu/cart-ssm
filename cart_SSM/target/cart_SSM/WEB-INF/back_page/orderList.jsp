            ...
            <table class="table table-striped table-bordered table-hover table-condensed">
                ...
                <c:forEach items="${orderList}" var="s" varStatus="status">
                    <tr>
                        ...
                        <td><a href="/editOrderHtml?id=${s.id}" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-edit"></span> </a></td>
                        <td><a href="/deleteOrder?id=${s.id}" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-edit"></span> </a></td>
